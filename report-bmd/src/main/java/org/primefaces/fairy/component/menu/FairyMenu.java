...
@ListenerFor(sourceClass = FairyMenu.class, systemEventClass = PostAddToViewEvent.class)
public class FairyMenu extends AbstractMenu implements Widget, ComponentSystemEventListener
{
    public static final String COMPONENT_TYPE = "org.primefaces.component.FairyMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.FairyMenuRenderer";
